...
csv_output_path = '/home/borwickja/PhpstormProjects/islandoraworkbench/islandora_workbench/input_data/church-kmbc/metadata.csv'
...
standard_fields = ['PID', 'mods_identifier_local_ms','mods_subject_authority_fast_topic_ms']
...
#                 addFieldToCSVHeaderRowMap(field_mapper, field_name, field_value)
            ...
            #field_alternative_title
                ...
                field_value = fieldmapper.get_titleInfo_alternative_title_fieldname()
                addFieldToCSVHeaderRowMap(field_mapper, field_name, field_value)
            ...
            #field_table_of_contents
               ...
               field_value = fieldmapper.get_table_of_contents_fieldname()
               addFieldToCSVHeaderRowMap(field_mapper, field_name, field_value)
            ...
            #field_subjects_name
               ...
               field_value = fieldmapper.get_subject_name_fieldname()
               addFieldToCSVHeaderRowMap(field_mapper, field_name, field_value)


            #maybe this goes into field_corp_alt_name, not sure
            elif field_name == "mods_subject_name_conference_namePart_ms":

               field_value = fieldmapper.get_name_conference_namepart_fieldname()
               addFieldToCSVHeaderRowMap(field_mapper, field_name, field_value)


            #field_access_condition (needs to be custom created)
            elif field_name == "mods_accessCondition_ms":

              # field_value = fieldmapper.()
               addFieldToCSVHeaderRowMap(field_mapper, field_name, field_value)
            ...
            #field_namepart (must be custom created)
...
def getFieldListFromFile():
    ...
    if os.path.exists('/home/borwickja/PycharmProjects/parseIslandoraCSV/mods-fields-minimum.txt'):
      filehandle =  open('/home/borwickja/PycharmProjects/parseIslandoraCSV/mods-fields-minimum.txt','r')
