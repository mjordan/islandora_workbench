...
def check_input(config, args):
    ...
    if config['task'] == 'create' and config['paged_content_from_directories'] is True:
        ...
        if 'paged_content_additional_page_media' in config:
            disable_action_message = 'Including the "paged_content_additional_page_media" setting in your configuration will create ' + \
            ...
            if 'paged_content_image_file_extension' not in config or 'paged_content_additional_page_media' not in config:
                message = 'If your configuration contains the "paged_content_additional_page_media" setting, it must also include both ' + \
